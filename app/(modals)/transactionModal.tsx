import {
  ...
  const TransactionModal = () => {
    ...
    const onSubmit = async () => {
      ...
      const res = { success: true, msg: "Transaction saved" }; // Placeholder
        ...
        <View style={styles.container}>
          ...
          >
            ...
            <View style={styles.inputContaier}>
              ...
              <TextInput
                style={[styles.dateInput, { height: verticalScale(80), textAlignVertical: 'top', paddingTop: spacingY._10 }]}
            ...
            <View style={styles.inputContaier}>
              <Typo color={colors.neutral200}>Transaction Icon (Optional)</Typo>
              {/* Image Input */}
              <ImageUpload
